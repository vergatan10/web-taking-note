            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('home') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">Notes</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ request()->is('notes') ? 'active' : '' }}">
                        <a href="{{ route('notes') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-note"></i>
                            <div class="text-truncate" data-i18n="My Notes">My Notes</div>
                        </a>
                    </li>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="https://api.dicebear.com/9.x/dylan/svg?seed=Brooklynn" alt
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src="https://api.dicebear.com/9.x/dylan/svg?seed=Brooklyn"
